...
VALUES
  ...
  ('AAM', 'AA Mission Acquisition Corp. Class A Ordinary Shares', 'NYSE'),
  ('AAME', 'Atlantic American Corporation Common Stock', 'NASDAQ'),
  ('AAMI', 'Acadian Asset Management Inc. Common Stock', 'NYSE'),
  ...
  ('AAUC', 'Allied Gold Corporation Common Shares', 'NYSE'),
  ...
  ('ABCB', 'Ameris Bancorp Common Stock', 'NYSE'),
  ...
  ('ABLV', 'Able View Global Inc. Class B Ordinary Shares', 'NASDAQ'),
  ...
  ('ACCS', 'ACCESS Newswire Inc. Common Stock', 'AMEX'),
  ...
  ('ACU', 'Acme United Corporation. Common Stock', 'AMEX'),
  ('ACV', 'Virtus Diversified Income & Convertible Fund Common Shares of Beneficial Interest', 'NYSE'),
  ('ACVA', 'ACV Auctions Inc. Class A Common Stock', 'NYSE'),
  ('ACXP', 'Acurx Pharmaceuticals Inc. Common Stock', 'NASDAQ'),
  ('AD', 'Array Digital Infrastructure Inc. Common Shares', 'NYSE'),
  ...
  ('ADC^A', 'Agree Realty Corporation Depositary Shares each representing 1/1000th of a 4.250% Series A Cumulative Redeemable Preferred Stock', 'NYSE'),
  ...
  ('AEF', 'abrdn Emerging Markets ex-China Fund Inc. Common Stock', 'AMEX'),
  ...
  ('AEON', 'AEON Biopharma Inc. Class A Common Stock', 'AMEX'),
  ...
  ('AEXA', 'American Exceptionalism Acquisition Corp. A Class A Ordinary Shares', 'NYSE'),
  ...
  ('AGM^H', 'Federal Agricultural Mortgage Corporation 6.500% Non-Cumulative Preferred Stock Series H', 'NYSE'),
  ...
  ('AGNCO', 'AGNC Investment Corp. Depositary Shares each representing a 1/1000th interest in a share of 6.50% Series E Fixed-to-Floating Cumulative Redeemable Preferred Stock', 'NASDAQ'),
  ...
  ('AHL', 'Aspen Insurance Holdings Limited Class A Ordinary Shares', 'NYSE'),
  ...
  ('AHL^F', 'Aspen Insurance Holdings Limited Depositary Shares each representing a 1/1000th Interest in a 7.00% Perpetual Non-Cumulative Preference Share', 'NYSE'),
  ...
  ('AII', 'American Integrity Insurance Group Inc. Common Stock', 'NYSE'),
  ('AIIO', 'Robo.ai Inc. Class B Ordinary Shares', 'NASDAQ'),
  ('AIIOW', 'Robo.ai Inc. Warrant', 'NASDAQ'),
  ('AIM', 'AIM ImmunoTech Inc. Common Stock', 'AMEX'),
  ...
  ('AIRI', 'Air Industries Group Common Stock', 'AMEX'),
  ...
  ('AKAN', 'Akanda Corp. Common Shares', 'NASDAQ'),
  ...
  ('ALH', 'Alliance Laundry Holdings Inc. Common Stock', 'NYSE'),
  ...
  ('ALL^H', 'Allstate Corporation (The) Depositary Shares each representing a 1/1000th interest in a share of Fixed Rate Noncumulative Perpetual Preferred Stock Series H', 'NYSE'),
  ('ALL^I', 'Allstate Corporation (The) Depositary Shares each representing a 1/1000th interest in a share of Fixed Rate Noncumulative Perpetual Preferred Stock Series I', 'NYSE'),
  ('ALL^J', 'Allstate Corporation (The) Depositary Shares each representing a 1/1000th interest in a share of Fixed Rate Noncumulative Perpetual Preferred Stock Series J', 'NYSE'),
  ...
  ('ALPS', 'ALPS Group Inc Ordinary Share', 'NASDAQ'),
  ...
  ('AMBQ', 'Ambiq Micro Inc. Common Stock', 'NYSE'),
  ...
  ('AMRZ', 'Amrize Ltd Ordinary Shares', 'NYSE'),
  ('AMS', 'American Shared Hospital Services Common Stock', 'AMEX'),
  ...
  ('AMTM', 'Amentum Holdings Inc. Common Stock', 'NYSE'),
  ...
  ('AMZE', 'Amaze Holdings Inc. Common Stock', 'AMEX'),
  ...
  ('ANGX', 'Angel Studios Inc. Class A Common Stock', 'NYSE'),
  ('ANG^D', 'American National Group Inc. Depositary Shares each representing a 1/1000th interest in a share of 7.375% Fixed-Rate Non-Cumulative Preferred Stock Series D', 'NYSE'),
  ...
  ('APT', 'Alpha Pro Tech Ltd. Common Stock', 'AMEX'),
  ('APTV', 'Aptiv PLC Ordinary Shares', 'NYSE'),
  ('APUS', 'Apimeds Pharmaceuticals US Inc. Common Stock', 'AMEX'),
  ...
  ('ARDT', 'Ardent Health Inc. Common Stock', 'NYSE'),
  ...
  ('AREN', 'The Arena Group Holdings Inc. Common Stock', 'AMEX'),
  ('ARES', 'Ares Management Corporation Class A Common Stock', 'NYSE'),
  ('ARES^B', 'Ares Management Corporation 6.75% Series B Mandatory Convertible Preferred Stock', 'NYSE'),
  ...
  ('ARMN', 'Aris Mining Corporation Common Shares', 'AMEX'),
  ...
  ('ARX', 'Accelerant Holdings Class A Common Shares', 'NYSE'),
  ...
  ('ASIC', 'Ategrity Specialty Insurance Company Holdings Common Stock', 'NYSE'),
  ('ASIX', 'AdvanSix Inc. Common Stock ', 'NYSE'),
  ('ASLE', 'AerSale Corporation Common Stock', 'NASDAQ'),
  ('ASM', 'Avino Silver & Gold Mines Ltd. Common Shares (Canada)', 'AMEX'),
  ...
  ('ATAI', 'Atai Beckley N.V Common Shares', 'NASDAQ'),
  ('ATAT', 'Atour Lifestyle Holdings Limited American Depositary Shares', 'NASDAQ'),
  ('ATCH', 'AtlasClear Holdings Inc. Common Stock', 'AMEX'),
  ...
  ('ATH^A', 'Athene Holding Ltd. Depositary Shares Each Representing a 1/1000th Interest in a 6.35% Fixed-to-Floating Rate Perpetual Non-Cumulative Preference Share Series A', 'NYSE'),
  ('ATH^B', 'Athene Holding Ltd. Depositary Shares Each Representing a 1/1000th Interest in a 5.625% Fixed Rate Perpetual Non- Cumulative Preference Share Series B par value $1.00 per share', 'NYSE'),
  ('ATH^D', 'Athene Holding Ltd. Depositary Shares Each Representing a 1/1000th Interest in a 4.875% Fixed-Rate Perpetual Non-Cumulative Preference Share Series D', 'NYSE'),
  ('ATH^E', 'Athene Holding Ltd. Depositary Shares Each Representing a 1/1000th Interest in a 7.750% Fixed-Rate Reset Perpetual Non-Cumulative Preference Share Series E', 'NYSE'),
  ...
  ('ATNM', 'Actinium Pharmaceuticals Inc. (Delaware) Common Stock', 'AMEX'),
  ...
  ('ATXG', 'Addentax Group Corp. Common Stock', 'NASDAQ'),
  ...
  ('AURE', 'Prestige Wealth Inc. Class A Ordinary Shares', 'NASDAQ'),
  ('AUROW', 'Aurora Innovation Inc. Warrant', 'NASDAQ'),
  ('AUST', 'Austin Gold Corp. Common Shares', 'AMEX'),
  ...
  ('AVBC', 'Avidia Bancorp Inc. Common Stock', 'NYSE'),
  ...
  ('AWX', 'Avalon Holdings Corporation Common Stock', 'AMEX'),
  ('AX', 'Axos Financial Inc. Common Stock', 'NYSE'),
  ('AXG', 'Solowin Holdings Class A Ordinary Share', 'NASDAQ'),
  ('AXGN', 'Axogen Inc. Common Stock', 'NASDAQ'),
  ('AXIL', 'AXIL Brands Inc. Common Stock', 'AMEX'),
  ...
  ('AYI', 'Acuity Inc. Common Stock', 'NYSE'),
  ...
  ('AZTR', 'Azitra Inc Common Stock', 'AMEX'),
  ('AZZ', 'AZZ Inc.', 'NYSE'),
  ('B', 'Barrick Mining Corporation Common Shares', 'NYSE'),
  ...
  ('BACQ', 'Inflection Point Acquisition Corp. IV Class A Ordinary Shares', 'NASDAQ'),
  ('BACQR', 'Inflection Point Acquisition Corp. IV Right', 'NASDAQ'),
  ('BACQU', 'Inflection Point Acquisition Corp. IV Unit', 'NASDAQ'),
  ('BAC^B', 'Bank of America Corporation Depositary Shares each representing a 1/1000th interest in a share of 6.000% Non-Cumulative Preferred Stock Series GG', 'NYSE'),
  ('BAC^E', 'Bank of America Corporation Depositary Sh repstg 1/1000th Perp Pfd Ser E', 'NYSE'),
  ('BAC^K', 'Bank of America Corporation Depositary Shares each representing a 1/1000th interest in a share of 5.875% Non- Cumulative Preferred Stock Series HH', 'NYSE'),
  ('BAC^L', 'Bank of America Corporation Non Cumulative Perpetual Conv Pfd Ser L', 'NYSE'),
  ('BAC^M', 'Bank of America Corporation Depositary Shares each representing a 1/1000th interest in a share of 5.375% Non-Cumulative Preferred Stock Series KK', 'NYSE'),
  ('BAC^N', 'Bank of America Corporation Depositary shares each representing 1/1000th interest in a share of 5.000% Non-Cumulative Preferred Stock Series LL', 'NYSE'),
  ('BAC^O', 'Bank of America Corporation Depositary shares each representing 1/1000th interest in a share of 4.375% Non-Cumulative Preferred Stock Series NN', 'NYSE'),
  ('BAC^P', 'Bank of America Corporation Depositary Shares each representing a 1/1000th interest in a share of 4.125% Non-Cumulative Preferred Stock Series PP', 'NYSE'),
  ('BAC^Q', 'Bank of America Corporation Depositary shares each representing 1/1000th interest in a share of 4.250% Non-Cumulative Preferred Stock Series QQ', 'NYSE'),
  ('BAC^S', 'Bank of America Corporation Depositary shares each representing 1/1000th interest in a share of 4.750% Non-Cumulative Preferred Stock Series SS', 'NYSE'),
  ...
  ('BANL', 'CBL International Limited Ordinary Shares', 'NASDAQ'),
  ...
  ('BATL', 'Battalion Oil Corporation Common Stock', 'AMEX'),
  ...
  ('BA^A', 'Boeing Company (The) Depositary Shares each representing a 1/20th interest in a share of 6.00% Series A Mandatory Convertible Preferred Stock par value $1.00', 'NYSE'),
  ('BB', 'BlackBerry Limited Common Stock', 'NYSE'),
  ('BBAI', 'BigBear.ai Inc. Common Stock', 'NYSE'),
  ('BBAR', 'Banco BBVA Argentina S.A. ADS', 'NYSE'),
  ('BBBY', 'Bed Bath & Beyond Inc. Common Stock', 'NYSE'),
  ...
  ('BBT', 'Beacon Financial Corporation Common stock', 'NYSE'),
  ...
  ('BCV^A', 'Bancroft Fund Limited 5.375% Series A Cumulative Preferred Shares', 'AMEX'),
  ...
  ('BDL', 'Flanigan''s Enterprises Inc. Common Stock', 'AMEX'),
  ...
  ('BETA', 'Beta Technologies Inc. Class A Common Stock', 'NYSE'),
  ...
  ('BGI', 'Birks Group Inc. Common Stock', 'AMEX'),
  ...
  ('BGSI', 'Boyd Group Services Inc. Common Shares', 'NYSE'),
  ...
  ('BHB', 'Bar Harbor Bankshares Inc. Common Stock', 'AMEX'),
  ...
  ('BHFAM', 'Brighthouse Financial Inc. Depositary shares each representing a 1/1000th Interest in a Share of 4.625% Non-Cumulative Preferred Stock Series D', 'NASDAQ'),
  ('BHFAN', 'Brighthouse Financial Inc. Depositary shares each representing a 1/1000th interest in a share of 5.375% Non-Cumulative Preferred Stock Series C', 'NASDAQ'),
  ...
  ('BHM', 'Bluerock Homes Trust Inc. Class A Common Stock', 'AMEX'),
  ...
  ('BKTI', 'BK Technologies Corporation Common Stock', 'AMEX'),
  ('BKU', 'BankUnited Inc. Common Stock', 'NYSE'),
  ('BKV', 'BKV Corporation Common Stock', 'NYSE'),
  ('BKYI', 'BIO-key International Inc. Common Stock', 'NASDAQ'),
  ('BK^K', 'The Bank Of New York Mellon Corporation  Depositary Shares each representing a 1/4000th interest in a share of Series K Noncumulative Perpetual Preferred Stock', 'NYSE'),
  ...
  ('BLLN', 'BillionToOne Inc. Class A Common Stock', 'NASDAQ'),
  ...
  ('BLSH', 'Bullish Ordinary Shares', 'NYSE'),
  ...
  ('BLZR', 'Trailblazer Acquisition Corp. Class A Ordinary Shares', 'NASDAQ'),
  ...
  ('BMNR', 'BitMine Immersion Technologies Inc. Common Stock', 'AMEX'),
  ...
  ('BOH^B', 'Bank of Hawaii Corporation Depositary Shares Each Representing a 1/40th Interest in a Share of 8.000% Fixed Rate Non-Cumulative Perpetual Preferred Stock Series B', 'NYSE'),
  ...
  ('BOW', 'Bowhead Specialty Holdings Inc. Common Stock', 'NYSE'),
  ...
  ('BQ', 'Boqii Holding Limited Class A Ordinary Shares', 'AMEX'),
  ...
  ('BRBS', 'Blue Ridge Bankshares Inc. Common Stock', 'AMEX'),
  ...
  ('BRIA', 'BrilliA Inc Class A Ordinary Shares', 'AMEX'),
  ...
  ('BRN', 'Barnwell Industries Inc. Common Stock', 'AMEX'),
  ...
  ('BRSL', 'Brightstar Lottery PLC Trading under the Legal Name to begin at the market open on July 21 2025. Ordinary Shares', 'NYSE'),
  ...
  ('BTG', 'B2Gold Corp Common shares (Canada)', 'AMEX'),
  ...
  ('BURU', 'Nuburu Inc. Common Stock', 'AMEX'),
  ...
  ('BWMX', 'Betterware de Mexico S.A.P.I. de C.V. Ordinary Shares', 'NYSE'),
  ...
  ('BYAH', 'Park Ha Biological Technology Co. Ltd. Ordinary Shares', 'NASDAQ'),
  ...
  ('CANF', 'Can-Fite Biopharma Ltd Sponsored ADR (Israel)', 'AMEX'),
  ...
  ('CBNA', 'Chain Bridge Bancorp Inc. Class A Common Stock', 'NYSE'),
  ...
  ('CBU', 'Community Financial System Inc. Common Stock', 'NYSE'),
  ...
  ('CCC', 'CCC Intelligent Solutions Holdings Inc. Common Stock', 'NASDAQ'),
  ...
  ('CCEL', 'Cryo-Cell International Inc. Common Stock', 'AMEX'),
  ...
  ('CEPV', 'Cantor Equity Partners V Inc. Class A Ordinary Shares', 'NASDAQ'),
  ('CERS', 'Cerus Corporation Common Stock', 'NASDAQ'),
  ('CERT', 'Certara Inc. Common Stock', 'NASDAQ'),
  ('CET', 'Central Securities Corporation Common Stock', 'AMEX'),
  ('CETX', 'Cemtrex Inc. Common Stock', 'NASDAQ'),
  ('CETY', 'Clean Energy Technologies Inc. Common Stock', 'NASDAQ'),
  ('CEV', 'Eaton Vance California Municipal Income Trust Shares of Beneficial Interest', 'AMEX'),
  ...
  ('CFG^H', 'Citizens Financial Group Inc. Depositary Shares Each Representing a 1/40th Interest in a Share of 7.375% Fixed-Rate Non-Cumulative Perpetual Preferred Stock Series H', 'NYSE'),
  ('CFG^I', 'Citizens Financial Group Inc. Depositary Shares Each Representing a 1/40th Interest in a Share of 6.500% Fixed-Rate Reset Non-Cumulative Perpetual Preferred Stock Series I', 'NYSE'),
  ('CFLT', 'Confluent Inc. Class A Common Stock', 'NASDAQ'),
  ('CFND', 'C1 Fund Inc. Common Stock', 'NYSE'),
  ...
  ('CHOW', 'ChowChow Cloud International Holdings Limited Ordinary Shares', 'AMEX'),
  ...
  ('CHSN', 'Chanson International Holding Class A Ordinary Shares', 'NASDAQ'),
  ...
  ('CIB', 'Grupo Cibest S.A. American Depositary Shares each representing four Preferred Shares', 'NYSE'),
  ...
  ('CII', 'BlackRock Enhanced Large Cap Core Fund Inc. Common Stock', 'NYSE'),
  ('CIIT', 'Tianci International Inc. Common Stock', 'NASDAQ'),
  ('CIK', 'Credit Suisse Asset Management Income Fund Inc. Common Stock', 'AMEX'),
  ...
  ('CIX', 'CompX International Inc. Common Stock', 'AMEX'),
  ('CJET', 'Chijet Motor Company Inc. Class A Ordinary Shares', 'NASDAQ'),
  ('CJMB', 'Callan JMB Inc. Common Stock', 'NASDAQ'),
  ('CKX', 'CKX Lands Inc. Common Stock', 'AMEX'),
  ...
  ('CLDI', 'Calidi Biotherapeutics Inc. Common Stock', 'AMEX'),
  ...
  ('CLM', 'Cornerstone Strategic Investment Fund Inc. Common Shares', 'AMEX'),
  ...
  ('CMA^B', 'Comerica Incorporated Depositary Shares each representing a 1/40th interest in a share of 6.875% Fixed-Rate Reset Non-Cumulative Perpetual Preferred Stock Series B', 'NYSE'),
  ('CMBM', 'Cambium Networks Corporation Ordinary Shares', 'NASDAQ'),
  ('CMBT', 'CMB.TECH NV Ordinary Shares', 'NYSE'),
  ('CMC', 'Commercial Metals Company Common Stock', 'NYSE'),
  ('CMCL', 'Caledonia Mining Corporation Plc Common Shares', 'AMEX'),
  ...
  ('CMDB', 'Costamare Bulkers Holdings Limited Common Stock', 'NYSE'),
  ...
  ('CMPO', 'CompoSecure Inc. Class A Common Stock', 'NYSE'),
  ...
  ('CMS^C', 'CMS Energy Corporation Depositary Shares each representing a 1/1000th interest in a share of 4.200% Cumulative Redeemable Perpetual Preferred Stock Series C', 'NYSE'),
  ('CMT', 'Core Molding Technologies Inc Common Stock', 'AMEX'),
  ...
  ('CNL', 'Collective Mining Ltd. Common Shares', 'AMEX'),
  ...
  ('CNR', 'Core Natural Resources Inc. Common Stock', 'NYSE'),
  ...
  ('COE', '51Talk Online Education Group American depositary shares each representing 60 Class A ordinary shares', 'AMEX'),
  ...
  ('CON', 'Concentra Group Holdings Parent Inc. Common Stock', 'NYSE'),
  ...
  ('COSO', 'CoastalSouth Bancshares Inc. Common Stock', 'NYSE'),
  ...
  ('CPHI', 'China Pharma Holdings Inc. Common Stock', 'AMEX'),
  ...
  ('CRCL', 'Circle Internet Group Inc. Class A Common Stock', 'NYSE'),
  ...
  ('CRF', 'Cornerstone Total Return Fund Inc. (The) Common Stock', 'AMEX'),
  ...
  ('CSW', 'CSW Industrials Inc. Common Stock', 'NYSE'),
  ...
  ('CTEV', 'Claritev Corporation Class A Common Stock', 'NYSE'),
  ('CTGO', 'Contango ORE Inc. Common Stock', 'AMEX'),
  ('CTKB', 'Cytek Biosciences Inc. Common Stock', 'NASDAQ'),
  ('CTLP', 'Cantaloupe Inc. Common Stock', 'NASDAQ'),
  ('CTM', 'Castellum Inc. Common Stock', 'AMEX'),
  ('CTMX', 'CytomX Therapeutics Inc. Common Stock', 'NASDAQ'),
  ('CTNM', 'Contineum Therapeutics Inc. Class A Common Stock', 'NASDAQ'),
  ('CTNT', 'Cheetah Net Supply Chain Service Inc. Class A Common Stock', 'NASDAQ'),
  ...
  ('CURB', 'Curbline Properties Corp. Common Stock', 'NYSE'),
  ...
  ('CVLG', 'Covenant Logistics Group Inc. Class A Common Stock', 'NYSE'),
  ('CVLT', 'Commvault Systems Inc. Common Stock', 'NASDAQ'),
  ('CVM', 'Cel-Sci Corporation Common Stock', 'AMEX'),
  ('CVNA', 'Carvana Co. Class A Common Stock', 'NYSE'),
  ('CVR', 'Chicago Rivet & Machine Co. Common Stock', 'AMEX'),
  ('CVRX', 'CVRx Inc. Common Stock', 'NASDAQ'),
  ('CVS', 'CVS Health Corporation Common Stock', 'NYSE'),
  ('CVU', 'CPI Aerostructures Inc. Common Stock', 'AMEX'),
  ...
  ('CYBN', 'Cybin Inc. Common Shares', 'AMEX'),
  ...
  ('DC', 'Dakota Gold Corp. Common Stock', 'AMEX'),
  ...
  ('DDC', 'DDC Enterprise Limited Class A Ordinary Shares', 'AMEX'),
  ...
  ('DGLY', 'Digital Ally Inc. Common Stock', 'NASDAQ'),
  ...
  ('DHY', 'Credit Suisse High Yield Credit Fund Common Stock', 'AMEX'),
  ...
  ('DIT', 'AMCON Distributing Company Common Stock', 'AMEX'),
  ...
  ('DNN', 'Denison Mines Corp Ordinary Shares (Canada)', 'AMEX'),
  ...
  ('DOOO', 'BRP Inc. (Recreational Products) Common Subordinate Voting Shares', 'NASDAQ'),
  ...
  ('DUK^A', 'Duke Energy Corporation Depositary Shares each representing a 1/1000th interest in a share of 5.75% Series A Cumulative Redeemable Perpetual Preferred Stock', 'NYSE'),
  ...
  ('DVS', 'Dolly Varden Silver Corporation Common Shares', 'AMEX'),
  ...
  ('DXF', 'Eason Technology Limited American Depositary Shares (each representing sixty-thousand (60000) Ordinary Shares)', 'AMEX'),
  ...
  ('EAD', 'Allspring Income Opportunities Fund Common Shares', 'AMEX'),
  ...
  ('ECF^A', 'Ellsworth Growth and Income Fund Ltd. 5.25% Series A Cumulative Preferred Shares (Liquidation Preference $25.00 per share)', 'AMEX'),
  ('ECG', 'Everus Construction Group Inc. Common Stock', 'NYSE'),
  ...
  ('EIM', 'Eaton Vance Municipal Bond Fund Common Shares of Beneficial Interest $.01 par value', 'AMEX'),
  ('EIX', 'Edison International Common Stock', 'NYSE'),
  ('EJH', 'E-Home Household Service Holdings Limited Ordinary Shares', 'NASDAQ'),
  ('EKSO', 'Ekso Bionics Holdings Inc. Common Stock', 'NASDAQ'),
  ('EL', 'Estee Lauder Companies Inc. (The) Common Stock', 'NYSE'),
  ('ELA', 'Envela Corporation Common Stock', 'AMEX'),
  ...
  ('ELLO', 'Ellomay Capital Ltd Ordinary Shares (Israel)', 'AMEX'),
  ('ELMD', 'Electromed Inc. Common Stock', 'AMEX'),
  ...
  ('ELWT', 'Elauwit Connection Inc. Common Stock', 'NASDAQ'),
  ('EM', 'Smart Share Global Limited American Depositary Shares', 'NASDAQ'),
  ('EMA', 'Emera Incorporated Common Shares', 'NYSE'),
  ('EMBC', 'Embecta Corp. Common Stock', 'NASDAQ'),
  ('EMBJ', 'Embraer S.A. Common Stock', 'NYSE'),
  ...
  ('EMX', 'EMX Royalty Corporation Common Shares (Canada)', 'AMEX'),
  ...
  ('EONR', 'EON Resources Inc. Class A Common Stock', 'AMEX'),
  ...
  ('EP', 'Empire Petroleum Corporation Common Stock', 'AMEX'),
  ...
  ('EPM', 'Evolution Petroleum Corporation Inc. Common Stock', 'AMEX'),
  ...
  ('EQH^C', 'Equitable Holdings Inc. Depositary Shares each representing a 1/1000th interest in a share of Fixed Rate Noncumulative Perpetual Preferred Stock Series C', 'NYSE'),
  ...
  ('EQX', 'Equinox Gold Corp. Common Shares', 'AMEX'),
  ('ERAS', 'Erasca Inc. Common Stock', 'NASDAQ'),
  ('ERC', 'Allspring Multi-Sector Income Fund Common Stock', 'AMEX'),
  ('ERH', 'Allspring Utilities and High Income Fund Common Shares', 'AMEX'),
  ...
  ('ESP', 'Espey Mfg. & Electronics Corp. Common Stock', 'AMEX'),
  ...
  ('ETSY', 'Etsy Inc. Common Stock', 'NYSE'),
  ...
  ('EVAC', 'EQV Ventures Acquisition Corp. II Class A Ordinary Shares', 'NYSE'),
  ...
  ('EVV', 'Eaton Vance Limited Duration Income Fund Common Shares of Beneficial Interest', 'AMEX'),
  ...
  ('EXOD', 'Exodus Movement Inc. Class A Common Stock', 'AMEX'),
  ...
  ('FAX', 'abrdn Asia-Pacific Income Fund Inc. Common Stock', 'AMEX'),
  ...
  ('FCO', 'abrdn Global Income Fund Inc. Common Stock', 'AMEX'),
  ...
  ('FERG', 'Ferguson Enterprises Inc. Common Stock', 'NYSE'),
  ...
  ('FHN^E', 'First Horizon Corporation Depositary Shares each representing a 1/4000th interest in a share of Non-Cumulative Perpetual Preferred Stock Series E', 'NYSE'),
  ...
  ('FIG', 'Figma Inc. Class A Common Stock', 'NYSE'),
  ...
  ('FLG', 'Flagstar Bank N.A. Common Stock', 'NYSE'),
  ('FLGC', 'Flora Growth Corp. Common Stock', 'NASDAQ'),
  ('FLGT', 'Fulgent Genetics Inc. Common Stock', 'NASDAQ'),
  ('FLG^A', 'Flagstar Bank N.A. Depositary shares each representing a 1/40th interest in a share of Fixed-to-Floating Rate Series A Noncumulative Perpetual Preferred Stock', 'NYSE'),
  ('FLG^U', 'Flagstar Bank N.A. Bifurcated Option Note Unit SecuritiES', 'NYSE'),
  ...
  ('FLOC', 'Flowco Holdings Inc. Class A Common Stock', 'NYSE'),
  ...
  ('FLYX', 'flyExclusive Inc. Class A Common Stock', 'AMEX'),
  ...
  ('FNF', 'Fidelity National Financial Inc. Common Stock', 'NYSE'),
  ...
  ('FOUR^A', 'Shift4 Payments Inc. 6.00% Series A Mandatory Convertible Preferred Stock', 'NYSE'),
  ...
  ('FSI', 'Flexible Solutions International Inc. Common Stock (CDA)', 'AMEX'),
  ...
  ('FSM', 'Fortuna Mining Corp. Common Shares', 'NYSE'),
  ('FSP', 'Franklin Street Properties Corp. Common Stock', 'AMEX'),
  ...
  ('FTEL', 'Fitell Corporation Class A Ordinary Shares', 'NASDAQ'),
  ('FTF', 'Franklin Limited Duration Income Trust Common Shares of Beneficial Interest', 'AMEX'),
  ...
  ('FTW', 'EQV Ventures Acquisition Corp. Class A Ordinary Shares', 'NYSE'),
  ('FUBO', 'FuboTV Inc. Class A Common Stock', 'NYSE'),
  ...
  ('FURY', 'Fury Gold Mines Limited Common Shares', 'AMEX'),
  ...
  ('FVR', 'FrontView REIT Inc. Common Stock', 'NYSE'),
  ...
  ('GAP', 'Gap Inc. (The) Common Stock', 'NYSE'),
  ...
  ('GBLI', 'Global Indemnity Group LLC Class A Common Stock ', 'NASDAQ'),
  ('GBR', 'New Concept Energy Inc Common Stock', 'AMEX'),
  ...
  ('GDC', 'GD Culture Group Limited Common Stock', 'NASDAQ'),
  ...
  ('GDO', 'Western Asset Global Corporate Opportunity Fund Inc. Common Stock', 'NYSE'),
  ...
  ('GENC', 'Gencor Industries Inc. Common Stock', 'AMEX'),
  ...
  ('GGN^B', 'GAMCO Global Gold Natural Reources & Income Trust 5.00% Series B Cumulative 25.00 Liquidation Preference', 'AMEX'),
  ...
  ('GIW', 'GigCapital8 Corp. Class A Ordinary Shares', 'NASDAQ'),
  ...
  ('GLDG', 'GoldMining Inc. Common Shares', 'AMEX'),
  ...
  ('GLO', 'Clough Global Opportunities Fund Common Stock', 'AMEX'),
  ...
  ('GLQ', 'Clough Global Equity Fund Clough Global Equity Fund Common Shares of Beneficial Interest', 'AMEX'),
  ...
  ('GLU', 'Gabelli Global Utility Common Shares of Beneficial Ownership', 'AMEX'),
  ('GLUE', 'Monte Rosa Therapeutics Inc. Common Stock', 'NASDAQ'),
  ('GLV', 'Clough Global Dividend and Income Fund Common Shares of beneficial interest', 'AMEX'),
  ...
  ('GNS', 'Genius Group Limited Ordinary Shares', 'AMEX'),
  ...
  ('GORO', 'Gold Resource Corporation Common Stock', 'AMEX'),
  ...
  ('GPUS', 'Hyperscale Data Inc. Common Stock', 'AMEX'),
  ('GPUS^D', 'Hyperscale Data Inc. 13.00% Series D Cumulative Redeemable Perpetual Preferred Stock', 'AMEX'),
  ('GRAB', 'Grab Holdings Limited Class A Ordinary Shares', 'NASDAQ'),
  ('GRABW', 'Grab Holdings Limited Warrant', 'NASDAQ'),
  ('GRAF', 'Graf Global Corp. Class A ordinary shares', 'AMEX'),
  ...
  ('GRDN', 'Guardian Pharmacy Services Inc. Class A Common Stock', 'NYSE'),
  ...
  ('GRF', 'Eagle Capital Growth Fund Inc. Common Stock', 'AMEX'),
  ...
  ('GTE', 'Gran Tierra Energy Inc. Common Stock', 'AMEX'),
  ...
  ('GTN', 'Gray Media Inc. Common Stock', 'NYSE'),
  ...
  ('HASI', 'HA Sustainable Infrastructure Capital Inc. Common Stock', 'NYSE'),
  ...
  ('HBR', 'Canary HBAR ETF Shares of Beneficial Interest', 'NASDAQ'),
  ...
  ('HCWC', 'Healthy Choice Wellness Corp. Class A Common Stock', 'AMEX'),
  ...
  ('HFRO^B', 'Highland Opportunities and Income Fund 5.375% Series B Cumulative Preferred Shares', 'NYSE'),
  ...
  ('HIG^G', 'The Hartford Insurance Group Inc. Depositary Shares each representing a 1/1000th interest in a share of 6.000% Non-Cumulative Preferred Stock Series G', 'NYSE'),
  ...
  ('HKIT', 'Hitek Global Inc. Class A Ordinary Share', 'NASDAQ'),
  ...
  ('HLP', 'Hongli Group Inc. Ordinary Shares', 'NASDAQ'),
  ...
  ('HNGE', 'Hinge Health Inc. Class A Common Stock', 'NYSE'),
  ...
  ('HOLO', 'MicroCloud Hologram Inc. Ordinary Shares', 'NASDAQ'),
  ...
  ('HPE^C', 'Hewlett Packard Enterprise Company 7.625% Series C Mandatory Convertible Preferred Stock', 'NYSE'),
  ...
  ('HTB', 'HomeTrust Bancshares Inc. Common Stock', 'NYSE'),
  ...
  ('HUDI', 'Huadi International Group Co. Ltd. Ordinary Shares', 'NASDAQ'),
  ...
  ('HUSA', 'Houston American Energy Corporation Common Stock', 'AMEX'),
  ...
  ('HYI', 'Western Asset High Yield Opportunity Fund Inc. Common Stock', 'NYSE'),
  ('HYLN', 'Hyliion Holdings Corp. Class A Common Stock', 'AMEX'),
  ...
  ('IAF', 'abrdn Australia Equity Fund Inc. Common Stock', 'AMEX'),
  ...
  ('IAUX', 'i-80 Gold Corp. Common Shares', 'AMEX'),
  ...
  ('IBO', 'Impact BioMedical Inc. Common Stock', 'AMEX'),
  ...
  ('IDR', 'Idaho Strategic Resources Inc. Common Stock', 'AMEX'),
  ...
  ('IE', 'Ivanhoe Electric Inc. Common Stock', 'AMEX'),
  ...
  ('IGC', 'IGC Pharma Inc. Common Stock', 'AMEX'),
  ('IGD', 'Voya Global Equity Dividend and Premium Opportunity Fund', 'NYSE'),
  ('IGI', 'Western Asset Investment Grade Opportunity Trust Inc. Common Stock', 'NYSE'),
  ...
  ('IHT', 'InnSuites Hospitality Trust Shares of Beneficial Interest', 'AMEX'),
  ...
  ('ILAG', 'Intelligent Living Application Group Inc. Ordinary Shares', 'NASDAQ'),
  ...
  ('IMO', 'Imperial Oil Limited Common Stock', 'AMEX'),
  ...
  ('IMSR', 'Terrestrial Energy Inc. Common Stock  ', 'NASDAQ'),
  ...
  ('INDO', 'Indonesia Energy Corporation Limited Ordinary Shares', 'AMEX'),
  ...
  ('INFU', 'InfuSystems Holdings Inc. Common Stock', 'AMEX'),
  ('INFY', 'Infosys Limited American Depositary Shares', 'NYSE'),
  ('ING', 'ING Group N.V. Common Stock', 'NYSE'),
  ('INGM', 'Ingram Micro Holding Corporation Common Stock', 'NYSE'),
  ...
  ('INLX', 'Intellinetics Inc. Common Stock', 'AMEX'),
  ...
  ('INR', 'Infinity Natural Resources Inc. Class A Common Stock', 'NYSE'),
  ...
  ('INTT', 'inTest Corporation Common Stock', 'AMEX'),
  ...
  ('INVX', 'Innovex International Inc. Common Stock', 'NYSE'),
  ...
  ('IOR', 'Income Opportunity Realty Investors Inc. Common Stock', 'AMEX'),
  ...
  ('ISOU', 'IsoEnergy Ltd. Common Shares', 'AMEX'),
  ...
  ('ITP', 'IT Tech Packaging Inc. Common Stock', 'AMEX'),
  ('ITRG', 'Integra Resources Corp. Common Shares', 'AMEX'),
  ...
  ('IZM', 'ICZOOM Group Inc. Class A Ordinary Shares', 'NASDAQ'),
  ('J', 'Jacobs Solutions Inc. Common Stock', 'NYSE'),
  ('JACK', 'Jack In The Box Inc. Common Stock', 'NASDAQ'),
  ('JACS', 'Jackson Acquisition Company II Class A Ordinary Shares', 'NYSE'),
  ...
  ('JBDI', 'JBDI Holdings Limited Ordinary Shares', 'NASDAQ'),
  ...
  ('JBS', 'JBS N.V. Class A Common Shares', 'NYSE'),
  ('JBSS', 'John B. Sanfilippo & Son Inc. Common Stock', 'NASDAQ'),
  ('JBTM', 'JBT Marel Corporation Common Stock', 'NYSE'),
  ...
  ('JCSE', 'JE Cleantech Holdings Limited Ordinary Shares', 'NASDAQ'),
  ...
  ('JENA', 'Jena Acquisition Corporation II Class A Ordinary Shares', 'NYSE'),
  ...
  ('JHX', 'James Hardie Industries plc. Ordinary Shares', 'NYSE'),
  ...
  ('JOB', 'GEE Group Inc. Common Stock', 'AMEX'),
  ...
  ('JXN^A', 'Jackson Financial Inc. Depositary Shares each representing a 1/1000th interest in a share of Fixed-Rate Reset Noncumulative Perpetual Preferred Stock Series A', 'NYSE'),
  ('JYD', 'Jayud Global Logistics Limited Class A Ordinary Shares', 'NASDAQ'),
  ('JYNT', 'The Joint Corp. Common Stock', 'NASDAQ'),
  ('JZ', 'Jianzhi Education Technology Group Company Limited American Depositary Shs', 'NASDAQ'),
  ...
  ('KAPA', 'Kairos Pharma Ltd. Common Stock', 'AMEX'),
  ...
  ('KIM^L', 'Kimco Realty Corporation Class L Depositary Shares each of which represents a one-one thousandth fractional interest in a share of 5.125% Class L Cumulative Redeemable Preferred Stock liquidation preference $25000.00 per share', 'NYSE'),
  ('KIM^M', 'Kimco Realty Corporation Class M Depositary Shares each of which represents a one-one thousandth fractional interest in a share of 5.25% Class M Cumulative Redeemable Preferred Stock liquidation preference $25000.00 per share', 'NYSE'),
  ('KIM^N', 'Kimco Realty Corporation Depositary Shares each representing 1/1000th interest in a share of 7.25% Class N Cumulative Convertible Perpetual Preferred Stock', 'NYSE'),
  ...
  ('KKR^D', 'KKR & Co. Inc. 6.25% Series D Mandatory Convertible Preferred Stock', 'NYSE'),
  ('KLAC', 'KLA Corporation Common Stock', 'NASDAQ'),
  ('KLAR', 'Klarna Group plc Ordinary Shares', 'NYSE'),
  ('KLC', 'KinderCare Learning Companies Inc. Common Stock', 'NYSE'),
  ...
  ('KNRX', 'KNOREX LTD. Class A Ordinary Shares', 'AMEX'),
  ...
  ('KRMN', 'Karman Holdings Inc. Common Stock', 'NYSE'),
  ...
  ('KULR', 'KULR Technology Group Inc. Common Stock', 'AMEX'),
  ...
  ('LAR', 'Lithium Argentina AG Common Shares', 'NYSE'),
  ...
  ('LCTX', 'Lineage Cell Therapeutics Inc. Common Stock', 'AMEX'),
  ...
  ('LEGT', 'Legato Merger Corp. III Ordinary Shares', 'AMEX'),
  ...
  ('LEU', 'Centrus Energy Corp. Class A Common Stock', 'AMEX'),
  ...
  ('LGCY', 'Legacy Education Inc. Common Stock', 'AMEX'),
  ...
  ('LGL', 'LGL Group Inc. (The) Common Stock', 'AMEX'),
  ...
  ('LGPS', 'LogProstyle Inc. Common Shares', 'AMEX'),
  ...
  ('LION', 'Lionsgate Studios Corp Common Shares', 'NYSE'),
  ...
  ('LKSP', 'Lake Superior Acquisition Corp. Class A Ordinary Shares', 'NASDAQ'),
  ...
  ('LNC^D', 'Lincoln National Corporation Depositary Shares Each Representing a 1/1000th Interest in a Share of 9.000% Non-Cumulative Preferred Stock Series D', 'NYSE'),
  ...
  ('LOB^A', 'Live Oak Bancshares Inc. Depositary Shares Each Representing a 1/40th Interest in a Share of 8.375% Fixed Rate Series A Non-Cumulative Perpetual Preferred Stock', 'NYSE'),
  ('LOCL', 'Local Bounti Corporation Common Stock', 'NYSE'),
  ('LOCO', 'El Pollo Loco Holdings Inc. Common Stock', 'NASDAQ'),
  ('LODE', 'Comstock Inc. Common Stock', 'AMEX'),
  ...
  ('LPA', 'Logistic Properties of the Americas Ordinary Shares', 'AMEX'),
  ...
  ('LSF', 'Laird Superfood Inc. Common Stock', 'AMEX'),
  ...
  ('LTCC', 'Canary Litecoin ETF Shares of Beneficial Interest', 'NASDAQ'),
  ('LTH', 'Life Time Group Holdings Inc. Common Stock', 'NYSE'),
  ('LTM', 'LATAM Airlines Group S.A. American Depositary Shares (each representing two thousand (2000) shares of Common Stock)', 'NYSE'),
  ...
  ('LUCK', 'Lucky Strike Entertainment Corporation Class A Common Stock', 'NYSE'),
  ('LUCY', 'Innovative Eyewear Inc. Common Stock', 'NASDAQ'),
  ('LUCYW', 'Innovative Eyewear Inc. Series A Warrants 8/16/27', 'NASDAQ'),
  ('LUD', 'Luda Technology Group Limited Ordinary Shares', 'AMEX'),
  ...
  ('LXFR', 'Luxfer Holdings PLC Ordinary Shares', 'AMEX'),
  ...
  ('MAGN', 'Magnera Corporation Common Stock', 'NYSE'),
  ('MAIA', 'MAIA Biotechnology Inc. Common Stock', 'AMEX'),
  ...
  ('MAMO', 'Massimo Group Common Stock', 'NASDAQ'),
  ...
  ('MCN', 'XAI Madison Equity Premium Income Fund Common Shares', 'NYSE'),
  ...
  ('MCRP', 'Micropolis Holding Company Ordinary Shares', 'AMEX'),
  ...
  ('MEGI', 'NYLI CBRE Global Infrastructure Megatrends Term Fund Common Shares', 'NYSE'),
  ('MEGL', 'Magic Empire Global Limited Class A Ordinary Shares', 'NASDAQ'),
  ('MEHA', 'Functional Brands Inc. Common Stock', 'NASDAQ'),
  ...
  ('MET^E', 'MetLife Inc. Depositary Shares ', 'NYSE'),
  ('MET^F', 'MetLife Inc. Depositary Shares each representing a 1/1000th interest in a share of 4.75% Non-Cumulative Preferred Stock Series F', 'NYSE'),
  ...
  ('MGLD', 'The Marygold Companies Inc. Common Stock', 'AMEX'),
  ...
  ('MI', 'NFT Limited Class A Ordinary Share', 'AMEX'),
  ('MIAX', 'Miami International Holdings Inc. Common Stock', 'NYSE'),
  ...
  ('MITQ', 'Moving iMage Technologies Inc. Common Stock', 'AMEX'),
  ...
  ('MLGO', 'MicroAlgo Inc. Class A Ordinary Shares', 'NASDAQ'),
  ...
  ('MMA', 'Mixed Martial Arts Group Limited Ordinary Shares', 'AMEX'),
  ('MMC', 'Marsh & McLennan Companies Inc. Common Stock', 'NYSE'),
  ('MMD', 'NYLI MacKay DefinedTerm Muni Opportunities Fund Common Shares', 'NYSE'),
  ...
  ('MNTN', 'MNTN Inc. Class A Common Stock', 'NYSE'),
  ...
  ('MPLT', 'MapLight Therapeutics Inc. Common Stock', 'NASDAQ'),
  ('MPLX', 'MPLX LP Common Units Representing Limited Partner Interests', 'NYSE'),
  ('MPTI', 'M-tron Industries Inc. Common Stock', 'AMEX'),
  ('MPU', 'Mega Matrix Inc. Class A Ordinary Shares', 'AMEX'),
  ...
  ('MRP', 'Millrose Properties Inc. Class A Common Stock', 'NYSE'),
  ('MRSN', 'Mersana Therapeutics Inc. Common Stock', 'NASDAQ'),
  ('MRT', 'Marti Technologies Inc. Class A Ordinary Shares', 'AMEX'),
  ...
  ('MSIF', 'MSC Income Fund Inc. Common Stock', 'NYSE'),
  ('MSM', 'MSC Industrial Direct Company Inc. Common Stock', 'NYSE'),
  ('MSN', 'Emerson Radio Corporation Common Stock', 'AMEX'),
  ...
  ('MSS', 'Maison Solutions Inc. Class A Common Stock', 'NASDAQ'),
  ...
  ('MS^K', 'Morgan Stanley Depositary Shares each representing 1/1000th of a share of Fixed-to-Floating Rate Non-Cumulative Preferred Stock  Series K', 'NYSE'),
  ('MS^L', 'Morgan Stanley Depositary Shares each representing 1/1000th of a share of 4.875% Non-Cumulative Preferred Stock Series L', 'NYSE'),
  ('MS^O', 'Morgan Stanley Depositary Shares each representing 1/1000th of a share of 4.250% Non-Cumulative Preferred Stock Series O', 'NYSE'),
  ('MS^P', 'Morgan Stanley Depositary Shares each representing 1/1000th of a share of 6.500% Non-Cumulative Preferred Stock Series P', 'NYSE'),
  ('MS^Q', 'Morgan Stanley Depositary Shares each representing 1/1000th of a share of 6.625% Non-Cumulative Preferred Stock Series Q', 'NYSE'),
  ('MT', 'Arcelor Mittal NY Registry Shares NEW', 'NYSE'),
  ('MTA', 'Metalla Royalty & Streaming Ltd. Common Shares', 'AMEX'),
  ...
  ('MTB^K', 'M&T Bank Corporation Depositary Shares each representing a 1/400th interest in a share of Perpetual 6.350% Non-Cumulative Preferred Stock Series K', 'NYSE'),
  ...
  ('MTNB', 'Matinas Biopharma Holdings Inc. Common Stock', 'AMEX'),
  ...
  ('MUX', 'McEwen Inc. Common Stock', 'NYSE'),
  ...
  ('MYND', 'Mynd.ai Inc. American Depositary Shares', 'AMEX'),
  ('MYNZ', 'Mainz Biomed N.V. Ordinary Shares', 'NASDAQ'),
  ('MYO', 'Myomo Inc. Common Stock', 'AMEX'),
  ...
  ('NAK', 'Northern Dynasty Minerals Ltd. Common Stock', 'AMEX'),
  ...
  ('NAVN', 'Navan Inc. Class A Common Stock', 'NASDAQ'),
  ...
  ('NBH', 'Neuberger Berman Municipal Fund Inc. Common Stock', 'AMEX'),
  ...
  ('NBP', 'NovaBridge Biosciences American Depositary Shares', 'NASDAQ'),
  ...
  ('NBY', 'NovaBay Pharmaceuticals Inc. Common Stock', 'AMEX'),
  ...
  ('NCEL', 'NewcelX Ltd. Ordinary Shares', 'NASDAQ'),
  ...
  ('NCL', 'Northann Corp. Common Stock', 'AMEX'),
  ...
  ('NEE^S', 'NextEra Energy Inc. 7.299% Corporate Units', 'NYSE'),
  ('NEE^T', 'NextEra Energy Inc. 7.234% Corporate Units', 'NYSE'),
  ('NEE^U', 'NextEra Energy Inc. Series U Junior Subordinated Debentures due June 1 2085', 'NYSE'),
  ('NEGG', 'Newegg Commerce Inc. Common Shares', 'NASDAQ'),
  ('NEM', 'Newmont Corporation', 'NYSE'),
  ('NEN', 'New England Realty Associates Limited Partnership Class A Depositary Receipts Evidencing Units of Limited Partnership', 'AMEX'),
  ...
  ('NEWP', 'New Pacific Metals Corp. Common Shares', 'AMEX'),
  ...
  ('NFGC', 'New Found Gold Corp Common Shares', 'AMEX'),
  ...
  ('NHC', 'National HealthCare Corporation Common Stock', 'AMEX'),
  ...
  ('NHS', 'Neuberger Berman High Yield Strategies Fund', 'AMEX'),
  ...
  ('NIQ', 'NIQ Global Intelligence plc Ordinary Shares', 'NYSE'),
  ...
  ('NLY^J', 'Annaly Capital Management Inc. 8.875% Series J Fixed-Rate Cumulative Redeemable Preferred Stock', 'NYSE'),
  ('NMAI', 'Nuveen Multi-Asset Income Fund Common Shares of Beneficial Interest', 'NYSE'),
  ('NMAX', 'Newsmax Inc. Class B Common Stock', 'NYSE'),
  ...
  ('NML', 'Neuberger Berman Energy Infrastructure and Income Fund Inc. Common Stock', 'AMEX'),
  ...
  ('NNVC', 'NanoViricides Inc. Common Stock', 'AMEX'),
  ...
  ('NOMA', 'NOMADAR Corp. Class A Common Stock', 'NASDAQ'),
  ...
  ('NP', 'Neptune Insurance Holdings Inc. Class A Common Stock', 'NYSE'),
  ...
  ('NPB', 'Northpointe Bancshares Inc. Common Stock', 'NYSE'),
  ...
  ('NPKI', 'NPK International Inc. Common Stock', 'NYSE'),
  ...
  ('NRXS', 'Neuraxis Inc. Common Stock', 'AMEX'),
  ...
  ('NSRX', 'Nasus Pharma Ltd. Ordinary Shares', 'AMEX'),
  ...
  ('NTIP', 'Network-1 Technologies Inc. Common Stock', 'AMEX'),
  ...
  ('NTRSO', 'Northern Trust Corporation Depositary Shares Each Representing a 1/1000th Interest in a Share of Series E Non-Cumulative Perpetual Preferred Stock', 'NASDAQ'),
  ...
  ('NXDR', 'Nextdoor Holdings Inc. Class A Common Stock', 'NYSE'),
  ...
  ('NXTT', 'Next Technology Holding Inc. Ordinary Shares', 'NASDAQ'),
  ...
  ('OBE', 'Obsidian Energy Ltd. Common Shares', 'AMEX'),
  ...
  ('OGEN', 'Oragenics Inc. Common Stock', 'AMEX'),
  ...
  ('OMH', 'Ohmyhome Limited Class A Ordinary Shares', 'NASDAQ'),
  ...
  ('ONIT', 'Onity Group Inc. Common Stock', 'NYSE'),
  ('ONL', 'Orion Properties Inc. Common Stock', 'NYSE'),
  ...
  ('OPHC', 'OptimumBank Holdings Inc. Common Stock', 'AMEX'),
  ...
  ('OPP^C', 'RiverNorth/DoubleLine Strategic Opportunity Fund Inc. 6.00% Series C Term Preferred Stock (Liquidation Preference $10.00 per share)', 'AMEX'),
  ...
  ('OPTT', 'Ocean Power Technologies Inc. Common Stock', 'AMEX'),
  ...
  ('OR', 'OR Royalties Inc. Common Shares', 'NYSE'),
  ...
  ('OSTX', 'OS Therapies Incorporated Common Stock', 'AMEX'),
  ...
  ('OTF', 'Blue Owl Technology Finance Corp. Common Stock', 'NYSE'),
  ('OTGA', 'OTG Acquisition Corp. I Class A Ordinary Share ', 'NASDAQ'),
  ...
  ('PAII', 'Pyrophyte Acquisition Corp. II Class A Ordinary Shares', 'NYSE'),
  ...
  ('PAPL', 'Pineapple Financial Inc. Common Stock', 'AMEX'),
  ...
  ('PAVS', 'Paranovus Entertainment Technology Ltd. Class A Ordinary Shares', 'NASDAQ'),
  ...
  ('PCG^A', 'Pacific Gas & Electric Co. 6% Preferred Stock', 'AMEX'),
  ('PCG^B', 'Pacific Gas & Electric Co. 5 1/2% Preferred Stock', 'AMEX'),
  ('PCG^C', 'Pacific Gas & Electric Co. 5% 1st Preferred Stock', 'AMEX'),
  ('PCG^D', 'Pacific Gas & Electric Co. 5% 1st  Red. Preferred Stock', 'AMEX'),
  ('PCG^E', 'Pacific Gas & Electric Co. 5% 1st A Preferred Stock', 'AMEX'),
  ('PCG^G', 'Pacific Gas & Electric Co. 4.80% 1st Preferred Stock', 'AMEX'),
  ('PCG^H', 'Pacific Gas & Electric Co. 4.50% 1st Preferred Stock', 'AMEX'),
  ('PCG^I', 'Pacific Gas & Electric Co. 4.36% 1st Preferred Stock', 'AMEX'),
  ('PCG^X', 'PG&E Corp 6.000% Series A Mandatory Convertible Preferred Stock', 'NYSE'),
  ...
  ('PDCC', 'Pearl Diver Credit Company Inc. Common Stock', 'NYSE'),
  ...
  ('PDM', 'Piedmont Realty Trust Inc. Class A Common Stock', 'NYSE'),
  ...
  ('PED', 'Pedevco Corp. Common Stock', 'AMEX'),
  ...
  ('PEW', 'GrabAGun Digital Holdings Inc. Common Stock', 'NYSE'),
  ...
  ('PHGE', 'BiomX Inc. COmmon Stock', 'AMEX'),
  ...
  ('PHXE^', 'Phoenix Energy One LLC Series A Cumulative Redeemable Preferred Shares', 'AMEX'),
  ...
  ('PLAG', 'Planet Green Holdings Corp. Common Stock', 'AMEX'),
  ...
  ('PLG', 'Platinum Group Metals Ltd. Ordinary Shares (Canada)', 'AMEX'),
  ...
  ('PLX', 'Protalix BioTherapeutics Inc. (DE) Common Stock', 'AMEX'),
  ...
  ('PMI', 'Picard Medical Inc. Common Stock', 'AMEX'),
  ...
  ('PMNT', 'Perfect Moment Ltd. Common Stock', 'AMEX'),
  ...
  ('PRK', 'Park National Corporation Common Stock', 'AMEX'),
  ...
  ('PRM', 'Perimeter Solutions SA Common Stock', 'NYSE'),
  ('PRMB', 'Primo Brands Corporation Class A Common Stock', 'NYSE'),
  ...
  ('PRSU', 'Pursuit Attractions and Hospitality Inc. Common Stock', 'NYSE'),
  ...
  ('PSA^F', 'Public Storage Depositary Shares Each Representing 1/1000 of a 5.15% Cumulative Preferred Share of Beneficial Interest Series F par value $0.01 per share', 'NYSE'),
  ('PSA^G', 'Public Storage Depositary Shares Each Representing 1/1000 of a 5.05% Cumulative Preferred Share of Beneficial Interest Series G', 'NYSE'),
  ('PSA^H', 'Public Storage Depositary Shares Each Representing 1/1000 of a  5.60% Cumulative Preferred  Share of Beneficial Interest Series H', 'NYSE'),
  ('PSA^I', 'Public Storage Depositary Shares Each Representing 1/1000 of a 4.875% Cumulative Preferred Share of Beneficial Interest Series I par value $0.01 per share', 'NYSE'),
  ('PSA^J', 'Public Storage Depositary Shares Each Representing 1/1000 of a 4.700% Cumulative Preferred Share of Beneficial Interest Series J par value $0.01 per share', 'NYSE'),
  ('PSA^K', 'Public Storage Depositary Shares Each Representing 1/1000 of a 4.75% Cumulative Preferred Share of Beneficial Interest Series K', 'NYSE'),
  ('PSA^L', 'Public Storage Depositary Shares Each Representing 1/1000 of a 4.625% Cumulative Preferred Share of Beneficial Interest Series L par value $0.01 per share', 'NYSE'),
  ('PSA^M', 'Public Storage Depositary Shares Each Representing 1/1000 of a 4.125% Cumulative Preferred Share of Beneficial Interest Series M', 'NYSE'),
  ('PSA^N', 'Public Storage Depositary Shares Each Representing 1/1000 of a 3.875% Cumulative Preferred Share of Beneficial Interest Series N', 'NYSE'),
  ('PSA^O', 'Public Storage Depositary Shares Each Representing 1/1000 of a 3.900% Cumulative Preferred Share of Beneficial Interest Series O', 'NYSE'),
  ('PSA^P', 'Public Storage Depositary Shares Each Representing 1/1000 of a 4.000% Cumulative Preferred Share of Bene cial Interest Series P', 'NYSE'),
  ('PSA^Q', 'Public Storage Depositary Shares Each Representing 1/1000 of a 3.950% Cumulative Preferred Share of Beneficial Interest Series Q par value $0.01 per share', 'NYSE'),
  ('PSA^R', 'Public Storage Depositary Shares Each Representing 1/1000 of a 4.00% Cumulative Preferred Share of Bene cial Interest Series R', 'NYSE'),
  ('PSA^S', 'Public Storage Depositary Shares Each Representing 1/1000 of a 4.100% Cumulative Preferred Share of Beneficial Interest Series S', 'NYSE'),
  ...
  ('PTHS', 'Pelthos Therapeutics Inc. Common Stock', 'AMEX'),
  ...
  ('PW', 'Power REIT (MD) Common Stock', 'AMEX'),
  ('PWP', 'Perella Weinberg Partners Class A Common Stock', 'NASDAQ'),
  ('PWR', 'Quanta Services Inc. Common Stock', 'NYSE'),
  ('PW^A', 'Power REIT 7.75% Series A Cumulative Perpetual Preferred Stock', 'AMEX'),
  ('PX', 'P10 Inc. Class A Common Stock', 'NYSE'),
  ('PXED', 'Phoenix Education Partners Inc. Common Stock', 'NYSE'),
  ...
  ('PZG', 'Paramount Gold Nevada Corp. Common Stock', 'AMEX'),
  ('PZZA', 'Papa John''s International Inc. Common Stock', 'NASDAQ'),
  ('Q', 'Qnity Electronics Inc. Common Stock', 'NYSE'),
  ...
  ('QXO', 'QXO Inc. Common Stock', 'NYSE'),
  ('QXO^B', 'QXO Inc.  Depositary Shares each representing a 1/20th interest in a share of 5.50% Series B Mandatory Convertible Preferred Stock', 'NYSE'),
  ...
  ('RAC', 'Rithm Acquisition Corp. Class A Ordinary Shares', 'NYSE'),
  ...
  ('RAL', 'Ralliant Corporation Common Stock', 'NYSE'),
  ...
  ('RC', 'Ready Capital Corporation Common Stock', 'NYSE'),
  ...
  ('RCG', 'RENN Fund Inc Common Stock', 'AMEX'),
  ...
  ('REI', 'Ring Energy Inc. Common Stock', 'AMEX'),
  ...
  ('REPX', 'Riley Exploration Permian Inc. Common Stock', 'AMEX'),
  ...
  ('RF^F', 'Regions Financial Corporation Depositary Shares Each Representing a 1/40th Interest in a Share of Non-Cumulative Perpetual Preferred Stock Series F', 'NYSE'),
  ('RGA', 'Reinsurance Group of America Incorporated Common Stock', 'NYSE'),
  ('RGC', 'Regencell Bioscience Holdings Limited Ordinary Shares', 'NASDAQ'),
  ...
  ('RITM^E', 'Rithm Capital Corp. 8.75% Series E Fixed-Rate Cumulative Redeemable Preferred Stock', 'NYSE'),
  ...
  ('RLGT', 'Radiant Logistics Inc. Common Stock', 'AMEX'),
  ...
  ('RNR^F', 'RenaissanceRe Holdings Ltd. Depositary Shares each Representing a 1/1000th Interest in a 5.750% Series F Preference Share', 'NYSE'),
  ('RNR^G', 'RenaissanceRe Holdings Ltd. Depositary Shares each representing a 1/1000th interest in a share of 4.20% Series G Preference Shares', 'NYSE'),
  ...
  ('ROLR', 'High Roller Technologies Inc. Common Stock', 'AMEX'),
  ...
  ('RPT', 'Rithm Property Trust Inc. Common stock', 'NYSE'),
  ('RPTX', 'Repare Therapeutics Inc. Common Shares', 'NASDAQ'),
  ('RPT^C', 'Rithm Property Trust Inc. 9.875% Series C Fixed-to-Floating Rate Cumulative Redeemable Preferred Stock', 'NYSE'),
  ...
  ('RVP', 'Retractable Technologies Inc. Common Stock', 'AMEX'),
  ...
  ('RYDE', 'Ryde Group Ltd. Class A Ordinary Shares', 'AMEX'),
  ...
  ('SACH^A', 'Sachem Capital Corp. 7.75% Series A Cumulative Redeemable Preferred Stock', 'AMEX'),
  ...
  ('SAGT', 'SAGTEC GLOBAL LIMITED Class A Ordinary shares', 'NASDAQ'),
  ...
  ('SARO', 'StandardAero Inc. Common Stock', 'NYSE'),
  ...
  ('SBDS', 'Solo Brands Inc. Class A Common Stock', 'NYSE'),
  ('SBET', 'SharpLink Gaming Inc. Common Stock', 'NASDAQ'),
  ('SBEV', 'Splash Beverage Group Inc. (NV) Common Stock', 'AMEX'),
  ...
  ('SBSI', 'Southside Bancshares Inc. Common Stock', 'NYSE'),
  ('SBSW', 'D/B/A Sibanye-Stillwater Limited ADS', 'NYSE'),
  ('SBUX', 'Starbucks Corporation Common Stock', 'NASDAQ'),
  ('SBXD', 'SilverBox Corp IV Class A Ordinary Shares', 'NYSE'),
  ...
  ('SCE^N', 'SCE Trust VIII 6.95% Trust Preference Securities', 'NYSE'),
  ...
  ('SEB', 'Seaboard Corporation Common Stock', 'AMEX'),
  ...
  ('SEG', 'Seaport Entertainment Group Inc. Common Stock', 'NYSE'),
  ('SEGG', 'Lottery.com Inc. Common Stock', 'NASDAQ'),
  ('SEI', 'Solaris Energy Infrastructure Inc. Class A Common Stock', 'NYSE'),
  ...
  ('SENS', 'Senseonics Holdings Inc. Common Stock', 'AMEX'),
  ('SEPN', 'Septerna Inc. Common Stock', 'NASDAQ'),
  ('SER', 'Serina Therapeutics Inc. Common Stock', 'AMEX'),
  ...
  ('SF^B', 'Stifel Financial Corporation Depositary Shares Each Representing 1/1000th  Interest in a Share of 6.25% Non-Cumulative  Preferred Stock Series B', 'NYSE'),
  ('SF^C', 'Stifel Financial Corporation Depositary Shares Each Representing 1/1000th Interest in a Share of 6.125% Non Cumulative Preferred Stock Series C', 'NYSE'),
  ('SF^D', 'Stifel Financial Corporation Depositary Shares Each Representing 1/1000th Interest in a Share of 4.50% Non-Cumulative Preferred Stock Series D', 'NYSE'),
  ...
  ('SGI', 'Somnigroup International Inc. Common Stock', 'NYSE'),
  ...
  ('SGN', 'Signing Day Sports Inc. Common Stock', 'AMEX'),
  ...
  ('SHPH', 'Shuttle Pharmaceuticals Holdings Inc. Common Stock', 'NASDAQ'),
  ('SHW', 'Sherwin-Williams Company (The) Common Stock', 'NYSE'),
  ('SI', 'Shoulder Innovations Inc. Common Stock', 'NYSE'),
  ...
  ('SIF', 'SIFCO Industries Inc. Common Stock', 'AMEX'),
  ...
  ('SIGIP', 'Selective Insurance Group Inc. Depositary Shares each representing a 1/1000th interest in a share of 4.60% Non-Cumulative Preferred Stock Series B', 'NASDAQ'),
  ('SII', 'Sprott Inc. Common Shares', 'NYSE'),
  ('SILA', 'Sila Realty Trust Inc. Common Stock', 'NYSE'),
  ('SILC', 'Silicom Ltd Ordinary Shares', 'NASDAQ'),
  ('SILO', 'Silo Pharma Inc. Common Stock', 'NASDAQ'),
  ('SIM', 'Grupo Simec S.A.B. de C.V. American Depositary Shares', 'AMEX'),
  ...
  ('SKY', 'Champion Homes Inc. Common Stock', 'NYSE'),
  ('SKYE', 'Skye Bioscience Inc. Common Stock', 'NASDAQ'),
  ('SKYH', 'Sky Harbour Group Corporation Class A Common Stock', 'NYSE'),
  ...
  ('SLI', 'Standard Lithium Ltd. Common Shares', 'AMEX'),
  ...
  ('SLND', 'Southland Holdings Inc. Common Stock', 'AMEX'),
  ...
  ('SLSR', 'Solaris Resources Inc. Common Shares', 'AMEX'),
  ...
  ('SMA', 'SmartStop Self Storage REIT Inc. Common Stock', 'NYSE'),
  ('SMBC', 'Southern Missouri Bancorp Inc. Common Stock', 'NASDAQ'),
  ('SMBK', 'SmartFinancial Inc. Common Stock', 'NYSE'),
  ('SMC', 'Summit Midstream Corporation Common Stock', 'NYSE'),
  ...
  ('SNOW', 'Snowflake Inc. Common Stock', 'NYSE'),
  ...
  ('SOAR', 'Volato Group Inc. Class A Common Stock', 'AMEX'),
  ('SOBO', 'South Bow Corporation Common Shares', 'NYSE'),
  ...
  ('SOLS', 'Solstice Advanced Materials Inc. Common Stock ', 'NASDAQ'),
  ...
  ('SOS', 'SOS Limited Class A Ordinary Shares', 'NYSE'),
  ('SOTK', 'Sono-Tek Corporation Common Stock', 'NASDAQ'),
  ('SOUL', 'Soulpower Acquisition Corporation Class A Ordinary Shares', 'NYSE'),
  ...
  ('SPMC', 'Sound Point Meridian Capital Inc. Common Stock', 'NYSE'),
  ...
  ('SRXH', 'SRX Health Solutions Inc. Common Stock', 'AMEX'),
  ('SRZN', 'Surrozen Inc. Common Stock', 'NASDAQ'),
  ('SRZNW', 'Surrozen Inc. Warrant', 'NASDAQ'),
  ('SR^A', 'Spire Inc. Depositary Shares each representing a 1/1000th interest in a share of 5.90% Series A Cumulative Redeemable Perpetual Preferred Stock', 'NYSE'),
  ('SSB', 'SouthState Bank Corporation Common Stock', 'NYSE'),
  ...
  ('STEC', 'Santech Holdings Limited American Depositary Shares', 'NASDAQ'),
  ...
  ('STRW', 'Strawberry Fields REIT Inc. Common Stock', 'AMEX'),
  ...
  ('STT^G', 'State Street Corporation Depositary shares each representing a 1/4000th ownership interest in a share of Fixed-to-Floating Rate Non-Cumulative', 'NYSE'),
  ('STUB', 'StubHub Holdings Inc. Class A Common Stock', 'NYSE'),
  ...
  ('SW', 'Smurfit WestRock plc Ordinary Shares', 'NYSE'),
  ...
  ('SWZ', 'Total Return Securities Fund Common Stock', 'NYSE'),
  ...
  ('SYNX', 'Silynxcom Ltd. Ordinary Shares', 'AMEX'),
  ...
  ('TBN', 'Tamboran Resources Corporation Common stock', 'NYSE'),
  ...
  ('TCGL', 'TechCreate Group Ltd. Class A Ordinary Shares', 'AMEX'),
  ...
  ('TDS^U', 'Telephone and Data Systems Inc. Depositary Shares Each Representing a 1/1000th Interest in a 6.625% Series UU Cumulative Redeemable Perpetual Preferred Stock', 'NYSE'),
  ('TDS^V', 'Telephone and Data Systems Inc. Depositary Shares Each Representing a 1/1000th Interest in a 6.000% Series VV Cumulative Redeemable Perpetual Preferred Stock', 'NYSE'),
  ...
  ('TE', 'T1 Energy Inc. Common Stock', 'NYSE'),
  ('TEAD', 'Teads Holding Co. Common Stock', 'NASDAQ'),
  ('TEAF', 'Tortoise Sustainable and Social Impact Term Fund Common shares of beneficial interest', 'NYSE'),
  ...
  ('TEN', 'Tsakos Energy Navigation Ltd Common Shares', 'NYSE'),
  ('TENB', 'Tenable Holdings Inc. Common Stock', 'NASDAQ'),
  ('TENX', 'Tenax Therapeutics Inc. Common Stock', 'NASDAQ'),
  ('TEN^E', 'Tsakos Energy Navigation Ltd Series E Fixed-to-Floating Rate Cumulative Redeemable Perpetual Preferred Shares par value $1.00', 'NYSE'),
  ('TEN^F', 'Tsakos Energy Navigation Ltd Series F Fixed-to-Floating Rate Cumulative Redeemable Perpetual Preferred Shares par value $1.00', 'NYSE'),
  ...
  ('TFC^O', 'Truist Financial Corporation Depositary Shares Each Representing a 1/1000th Interest in a Share of Series O Non-Cumulative Perpetual Preferred Stock', 'NYSE'),
  ('TFC^R', 'Truist Financial Corporation Depositary Shares each representing 1/1000th interest in a share of Series R Non-Cumulative Perpetual Preferred Stock', 'NYSE'),
  ('TFII', 'TFI International Inc. Common Shares', 'NYSE'),
  ('TFIN', 'Triumph Financial Inc. Common Stock', 'NYSE'),
  ('TFIN^', 'Triumph Financial Inc. Depositary Shares Each Representing a 1/40th Interest in a Share of 7.125% Series C Fixed-Rate Non-Cumulative Perpetual Preferred Stock', 'NYSE'),
  ...
  ('TGB', 'Taseko Mines Ltd. Common Stock', 'AMEX'),
  ('TGE', 'The Generation Essentials Group Class A Ordinary Shares', 'NYSE'),
  ('TGEN', 'Tecogen Inc. Common Stock', 'AMEX'),
  ('TGHL', 'The GrowHub Limited Class A Ordinary Shares', 'NASDAQ'),
  ('TGL', 'Treasure Global Inc. Common Stock', 'NASDAQ'),
  ...
  ('THM', 'International Tower Hill Mines Ltd. Ordinary Shares (Canada)', 'AMEX'),
  ...
  ('TIC', 'TIC Solutions Inc. Common Stock', 'NYSE'),
  ...
  ('TK', 'Teekay Corporation Ltd. Common Stock', 'NYSE'),
  ...
  ('TMDE', 'TMD Energy Limited Ordinary Shares', 'AMEX'),
  ...
  ('TMP', 'Tompkins Financial Corporation Common Stock', 'AMEX'),
  ('TMQ', 'Trilogy Metals Inc. Common Stock', 'AMEX'),
  ...
  ('TOON', 'Kartoon Studios Inc. Common Stock', 'AMEX'),
  ('TOP', 'TOP Financial Group Limited Class A Ordinary Shares', 'NASDAQ'),
  ('TOPP', 'Toppoint Holdings Inc. Common Stock', 'AMEX'),
  ('TOPS', 'TOP Ships Inc. Common Stock', 'AMEX'),
  ...
  ('TOVX', 'Theriva Biologics Inc. Common Stock', 'AMEX'),
  ...
  ('TPET', 'Trio Petroleum Corp. Common Stock', 'AMEX'),
  ...
  ('TRT', 'Trio-Tech International Common Stock', 'AMEX'),
  ...
  ('TRTN^F', 'Triton International Limited 7.625% Series F Cumulative Redeemable Perpetual Preference Shares', 'NYSE'),
  ...
  ('TRX', 'TRX Gold Corporation Common Stock', 'AMEX'),
  ...
  ('TTAM', 'Titan America SA Common Shares', 'NYSE'),
  ...
  ('TXNM', 'TXNM Energy Inc. Common Stock', 'NYSE'),
  ...
  ('T^A', 'AT&T Inc. Depositary Shares each representing a 1/1000th interest in a share of 5.000% Perpetual Preferred Stock Series A', 'NYSE'),
  ('T^C', 'AT&T Inc. Depositary Shares each representing a 1/1000th interest in a share of 4.750% Perpetual Preferred Stock Series C', 'NYSE'),
  ...
  ('UAMY', 'United States Antimony Corporation Common Stock', 'AMEX'),
  ('UAN', 'CVR Partners LP Common Units representing Limited Partner Interests', 'NYSE'),
  ('UAVS', 'AgEagle Aerial Systems Inc. Common Stock', 'AMEX'),
  ...
  ('UCAR', 'U Power Limited Class A Ordinary Shares', 'NASDAQ'),
  ('UCB', 'United Community Banks Inc. Common Stock', 'NYSE'),
  ...
  ('UEC', 'Uranium Energy Corp. Common Stock', 'AMEX'),
  ...
  ('UKOMW', 'Ucommune International Ltd Warrant', 'NASDAQ'),
  ...
  ('UMAC', 'Unusual Machines Inc. Common Stock', 'AMEX'),
  ...
  ('URG', 'Ur Energy Inc Common Shares (Canada)', 'AMEX'),
  ...
  ('USAS', 'Americas Gold and Silver Corporation Common Shares no par value', 'AMEX'),
  ('USAU', 'U.S. Gold Corp. Common Stock', 'NASDAQ'),
  ('USB', 'U.S. Bancorp Common Stock', 'NYSE'),
  ('USBC', 'USBC Inc. Common Stock', 'AMEX'),
  ...
  ('USB^P', 'U.S. Bancorp Depositary Shares each representing a 1/1000th interest in a share of Series K Non-Cumulative Perpetual Preferred Stock', 'NYSE'),
  ('USB^Q', 'U.S. Bancorp Depositary Shares Each Representing a 1/1000th Interest in a Share of Series L Non-Cumulative Perpetual Preferred Stock', 'NYSE'),
  ('USB^R', 'U.S. Bancorp Depositary Shares Each Representing a 1/1000th Interest in a Share of Series M Non-Cumulative Perpetual Preferred Stock', 'NYSE'),
  ('USB^S', 'U.S. Bancorp Depositary Shares each representing a 1/1000th interest in a share of Series O Non-Cumulative Perpetual Preferred Stock', 'NYSE'),
  ...
  ('UTG', 'Reaves Utility Income Fund Common Shares of Beneficial Interest', 'AMEX'),
  ...
  ('UUU', 'Universal Safety Products Inc. Common Stock', 'AMEX'),
  ('UUUU', 'Energy Fuels Inc Ordinary Shares (Canada)', 'AMEX'),
  ...
  ('VENU', 'Venu Holding Corporation Common Stock', 'AMEX'),
  ...
  ('VFL', 'abrdn National Municipal Income Fund Common Stock', 'AMEX'),
  ...
  ('VGZ', 'Vista Gold Corp Common Stock', 'AMEX'),
  ('VHC', 'VirnetX Holding Corp Common Stock', 'NASDAQ'),
  ('VHI', 'Valhi Inc. Common Stock', 'NYSE'),
  ('VIA', 'Via Transportation Inc. Class A Common Stock', 'NYSE'),
  ...
  ('VIRT', 'Virtu Financial Inc. Class A Common Stock', 'NYSE'),
  ...
  ('VKI', 'Invesco Advantage Municipal Income Trust II Common Shares of Beneficial Interest (DE)', 'AMEX'),
  ...
  ('VNTG', 'Vantage Corp Class A Ordinary Shares', 'AMEX'),
  ...
  ('VOYG', 'Voyager Technologies Inc. Class A Common Stock', 'NYSE'),
  ...
  ('VTAK', 'Catheter Precision Inc. Common Stock', 'AMEX'),
  ...
  ('VZLA', 'Vizsla Silver Corp. Common Shares', 'AMEX'),
  ...
  ('WAI', 'Top KingWin Ltd Class A Ordinary Shares', 'NASDAQ'),
  ...
  ('WBS^F', 'Webster Financial Corporation Depositary Shares Each Representing 1/1000th Interest in a Share of 5.25% Series F Non-Cumulative Perpetual Preferred Stock', 'NYSE'),
  ...
  ('WFC^A', 'Wells Fargo & Company Depositary Shares each representing a 1/1000th interest in a share of Non-Cumulative Perpetual Class A Preferred Stock Series AA', 'NYSE'),
  ('WFC^C', 'Wells Fargo & Company Depositary Shares each representing a 1/1000th interest in a share of Non-Cumulative Perpetual Class A Preferred Stock Series CC', 'NYSE'),
  ('WFC^D', 'Wells Fargo & Company Depositary Shares each representing a 1/1000th interest in  a share of Non-Cumulative Perpetual Class A Preferred Stock Series DD', 'NYSE'),
  ('WFC^L', 'Wells Fargo & Company 7.50% Non-Cumulative Perpetual Convertible Class A Preferred Stock Series L', 'NYSE'),
  ('WFC^Y', 'Wells Fargo & Company Depositary Shares each representing a 1/1000th interest in a share of Non-Cumulative Perpetual Class A Preferred Stock Series Y', 'NYSE'),
  ('WFC^Z', 'Wells Fargo & Company Depositary Shares each representing a 1/1000th interest in a share of Non-Cumulative Perpetual Class A Preferred Stock Series Z', 'NYSE'),
  ...
  ('WIMI', 'WiMi Hologram Cloud Inc. Class B Ordinary Shares', 'NASDAQ'),
  ...
  ('WRN', 'Western Copper and Gold Corporation Common Stock', 'AMEX'),
  ...
  ('WTFCN', 'Wintrust Financial Corporation Depositary Shares Each Representing a 1/1000th Interest in a Share of 7.875% Fixed-Rate Reset Non-Cumulative Perpetual Preferred StocK', 'NASDAQ'),
  ...
  ('WTO', 'UTime Limited Class A Ordinary Shares', 'NASDAQ'),
  ...
  ('WWR', 'Westwater Resources Inc. Common Stock', 'AMEX'),
  ...
  ('WYY', 'WidePoint Corporation Common Stock', 'AMEX'),
  ...
  ('XPL', 'Solitario Resources Corp. Common Stock', 'AMEX'),
  ...
  ('XRPN', 'Armada Acquisition Corp. II Class A Ordinary Shares', 'NASDAQ'),
  ...
  ('XTKG', 'X3 Holdings Co. Ltd. Ordinary Shares', 'NASDAQ'),
  ('XTLB', 'XTL Biopharmaceuticals Ltd. American Depositary Shares', 'NASDAQ'),
  ('XTNT', 'Xtant Medical Holdings Inc. Common Stock', 'AMEX'),
  ...
  ('XZO', 'Exzeo Group Inc. Common Stock', 'NYSE'),
  ...
  ('YCY', 'AA Mission Acquisition Corp. II Class A Ordinary Shares', 'NYSE'),
  ...
  ('ZDAI', 'DirectBooking Technology Co. Ltd. Ordinary Shares', 'NASDAQ'),
  ('ZDGE', 'Zedge Inc. Class B Common Stock ', 'AMEX'),
  ...
  ('ZJYL', 'JIN MEDICAL INTERNATIONAL LTD. Ordinary Shares', 'NASDAQ'),
  ...
  ('ZONE', 'CleanCore Solutions Inc. Class B Common Stock', 'AMEX'),
